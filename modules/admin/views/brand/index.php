        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <a href="<?php echo Url::toRoute('brand/edit') ?>" class="btn btn-success btn-flat" style="color:#FFFFFF">添加</a>
                    </div>
                </div><!-- /.box-header -->
                    ...
                    <table class="table table-hover">
                        ...
                        foreach($list as $brand){
                            ...
                            <tr>
                                <td>'.$brand->title.'</td>
                                <td>
                                    <a class="btn btn-social-icon btn-facebook" title="编辑" href="'.Url::toRoute(['brand/edit','brandId'=>$brand->id]).'"><i class="fa fa-edit"></i></a>
                                    <a class="btn btn-social-icon btn-danger del" title="删除" href="'.Url::toRoute(['brand/del','brandId'=>$brand->id]).'"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                            ';
                        }
